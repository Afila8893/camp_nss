...
from camp.models import Coordinator, Volunteer, Student, Event, AttendanceRecord, Notification, FinancialRecord
...
def homepage(request):
    return render(request, 'camp/homepage.html')
...
def custom_admin_login(request):
    if request.method == 'POST':
        ...
        if username in ALLOWED_USERS and ALLOWED_USERS[username] == password:
            ...
            return render(request, 'camp/admin_login.html', {'error': error})

    return render(request, 'camp/admin_login.html')

def green_guardians(request):
    return render(request, 'camp/green_guardians.html')

def rural_health_ambassadors(request):
    return render(request, 'camp/rural_health_ambassadors.html')

def each_one_teach_one(request):
    return render(request, 'camp/each_one.html')

def skillup_saturdays(request):
    return render(request, 'camp/skillup.html')

def mission_graam_upliftment(request):
    return render(request, 'camp/mission.html')

def disaster_readiness_crew(request):
    return render(request, 'camp/disaster.html')
@login_required
def admin_home(request):
    return render(request, 'camp/admin_homepage.html')
...
def register_volunteer(request):
    ...
    return render(request, 'camp/register_volunteer.html', {'form': form})
...
def register_coordinator(request):
    ...
    return render(request, 'camp/register_coordinator.html', {'form': form})
...
def coordinator_login(request):
    ...
    return render(request, 'camp/coordinator_login.html', {'form': form})
...
def coordinator_dashboard(request):
    ...
    return render(request, 'camp/coordinator_dashboard.html', context)

def registration_success(request):
    return render(request, 'camp/registration_success.html')
...
def attendance_tracker(request):
    ...
    return render(request, 'camp/attendance_tracker.html', {
        'events': events,
        'students': students,
        'attendance_records': attendance_records,
    })
...
def upload_event(request):
    ...
    return render(request, 'camp/upload_event.html')
...
def send_notification(request): 
    ...
    return render(request, 'camp/send_notification.html')
...
def financial_record(request):
    ...
    return render(request, 'camp/financial_record.html', {'transactions': transactions})
...
def volunteer_login(request):
    ...
    return render(request, 'camp/volunteer_login.html', {'form': form})
...
def volunteer_dashboard(request):
    ...
    return render(request, 'camp/volunteer_dashboard.html', {
        'volunteer': volunteer,
        'attendance_records': attendance_records,
        'events': events,
...
def nss_page(request):
    return render(request, 'camp/std.html')

def home(request):
    return render(request, 'camp/admin_homepage.html')

def about(request):
    return render(request, 'camp/about.html')

def services(request):
    return render(request, 'camp/services.html')
...
def alerts(request):
    return render(request, 'camp/alert.html')
...
def profile_view(request):
    ...
    volunteer = Volunteer.objects.get(id=volunteer_id)
    return render(request, 'camp/profile.html', {'volunteer': volunteer})
